...
public class ControlStatements {
	...
	public static void main(String[] args) {
		...
		int num = 1;
		//initialized var; bounds for loop; change var value
		for( ; ; ) { //valid for loop
			
			
			num += 2; //iteration defined in the loop
			if(num == args.length) break; //the condition defined also in the loop
		}
		
		// FOR-EACH AKA ENHANCED FOR LOOP - FOR ITERATING THROUGH ARRAYS
		for(String str: args) {
		...
		case 1: System.out.println(1); 
			break; // you can also use return. YOU CANNOT USE BOTH
